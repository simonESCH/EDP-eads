...
Physical Line("entre") = {15, 16};//condition of dirichlet: T=T0, u_a=f_entre
Physical Line("sortie") = {22, 23};//condition ... :
...
Physical Surface("Poiseuille") = {27};//passage of the air 
